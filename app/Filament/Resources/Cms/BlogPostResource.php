        ...
        return Forms\Components\Section::make(__('Infos. Gerais'))
            ...
            ->schema([
                ...
                Forms\Components\TextInput::make('cms_post.embed_video')
                    ...
                    ->required(
                        fn(Get $get): bool =>
                        in_array($get('role'), [4]) && empty($get('video')), // 4 - Vídeo
                    )
                    ->maxLength(255)
                    ->live(onBlur: true)
                    ->hidden(
                ...
                Forms\Components\SpatieMediaLibraryFileUpload::make('video')
                    ...
                    ->required(
                        fn(Get $get): bool =>
                        in_array($get('role'), [4]) && empty($get('cms_post.embed_video')), // 4 - Vídeo
                    )
                    ->maxSize(15360)
        ...
        return Forms\Components\Section::make(__('Infos. Complementares'))
            ...
            ->schema([
                ...
                Forms\Components\Fieldset::make(__('Otimização para motores de busca (SEO)'))
                    ...
                    ->hidden(
                        // 1 - Artigo; 3 - Galeria de Fotos e Vídeos; 4 - Vídeo
                        fn(Get $get): bool =>
                        !in_array($get('role'), [1, 3, 4]),
                    ),
            ...
            ->bulkActions([
                Tables\Actions\BulkActionGroup::make([
                    Tables\Actions\DeleteBulkAction::make()
                        ->hidden(
                            fn(): bool =>
                            !auth()->user()->can('Deletar [CMS] Blog'),
                        ),
                ]),
            ])
            ->emptyStateActions([
    ...
    public static function getTableFilters(): array
    {
        return [
            ...
            Tables\Filters\Filter::make('cmsPost.created_at')
                ...
                ->indicateUsing(
                    fn(BlogPostService $service, mixed $state): ?string =>
