        ...
        return Forms\Components\Section::make(__('Infos. Gerais'))
            ...
            ->schema([
                ...
                Forms\Components\TextInput::make('cms_post.slug')
                    ...
                    ->maxLength(255)
                    ->rules([
                        function (PostService $service, ?Service $record): Closure {
                            return function (
                                string $attribute,
                                mixed $state,
                                Closure $fail
            ...
            ->actions([
                Tables\Actions\ActionGroup::make([
                        ...
                        Tables\Actions\ViewAction::make()
                            ->extraModalFooterActions([
                                Tables\Actions\Action::make('edit')
                                    ...
                                    ->hidden(
                                        fn(): bool =>
                                        !auth()->user()->can('Editar [CMS] Serviços'),
                                    ),
                            ]),
                    ...
                    Tables\Actions\DeleteAction::make()
                        ->label(__('Excluir'))
                        ->before(
                            fn(ServicePostService $service, Tables\Actions\DeleteAction $action, Service $record) =>
            ...
            ->bulkActions([
                Tables\Actions\BulkActionGroup::make([
                    Tables\Actions\DeleteBulkAction::make()
                        ->hidden(
                            fn(): bool =>
                            !auth()->user()->can('Deletar [CMS] Serviços'),
                        ),
                ]),
            ])
            ->emptyStateActions([
    ...
    public static function getTableColumns(): array
    {
        return [
            ...
            Tables\Columns\TextColumn::make('role')
                ...
                ->badge()
                ->searchable(
                    query: fn(ServicePostService $service, Builder $query, string $search): Builder =>
                    $service->tableSearchByRole(query: $query, search: $search)
                )
                ->sortable(
                    query: fn(ServicePostService $service, Builder $query, string $direction): Builder =>
    ...
    public static function getTableFilters(): array
    {
        return [
            ...
            Tables\Filters\Filter::make('cmsPost.created_at')
                ...
                ->indicateUsing(
                    fn(ServicePostService $service, mixed $state): ?string =>
                        ...
                        Infolists\Components\Tabs\Tab::make(__('Mídias'))
                            ->schema([
                                ...
                                Infolists\Components\TextEntry::make('cmsPost.embed_video')
                                    ->label(__('Vídeo destaque no Youtube'))
                                    ->state(
                                        function (Service $record): ?string {
